...
alias dir-help='() {
  ...
  echo "  t_md              - Create README.md file"
  echo "  t_txt             - Create README.txt file"
  echo "  t_py              - Create Python file"
  echo "  t_sh              - Create executable Shell script"
  echo "  t_js              - Create JavaScript file"
  echo "  t_json            - Create JSON file"
  echo "  t_html            - Create HTML file"
  echo "  cf_files          - Create multiple files with specified prefix and suffix"
  echo "  tf_dir_ext_file   - Create files with new extension based on existing files"
