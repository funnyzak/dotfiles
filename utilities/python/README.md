...
python3 <(curl -s https://cdn.jsdelivr.net/gh/funnyzak/dotfiles@main/utilities/python/bria/background_remover.py)

# Command-line mode
python3 <(curl -s https://cdn.jsdelivr.net/gh/funnyzak/dotfiles@main/utilities/python/bria/background_remover.py) --api_token YOUR_API_TOKEN --url https://example.com/image.jpg --output_path ./output
```
...
2. **Download the Script**:
   ...
   ```bash
   curl -o background_remover.py https://cdn.jsdelivr.net/gh/funnyzak/dotfiles@main/utilities/python/bria/background_remover.py
