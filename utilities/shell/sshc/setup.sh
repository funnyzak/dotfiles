...
download_templates() {
  ...
  local gitee_base_url="https://cdn.jsdelivr.net/gh/funnyzak/dotfiles@${REPO_BRANCH:-main}/utilities/shell/sshc"
...
show_instructions() {
  ...
  echo "  - Using environment variable: SSHC_CONNECT_SERVER_ID=web1 ~/.ssh/ssh_connect.exp"
  echo "  - Using environment variable: SSHC_CONNECT_CONFIG=~/my_servers.conf ~/.ssh/ssh_connect.exp"
  echo ""
